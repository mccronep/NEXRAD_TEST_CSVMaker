...
#  Version 002   , Dated 2025-DEC-10  All Zenity.
#
#========================================================================================
...
#
PROGRAM_NAME="gui_csvmaker_v002.py"
#
#xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
for x in dataset.index:
    ...
    if VALID_THISPATH:
        ...
        if not OS.path.isdir(CWD_PATH):
            ...
            continue # Exit if the script directory is invalid
        ...
        file_processes = {
            "NCR": "process_level3_files_NCR_v11_tvso.py",
            "NTV": "process_level3_files_NTV_v11_tvso.py",
            "NMD": "process_level3_files_NMD_v11_tvso.py",
        }
        ...
        for file_type, script_filename in file_processes.items():
            ...
            # B. Copy the files
            copy_command = ["cp", file_pattern, data_dir]

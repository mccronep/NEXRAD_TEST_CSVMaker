...
# NAME:
# :::::::::::::::::::::::::::::::::::::::::::::::
# process_level3_files_NST_v11_csvo.py
# :::::::::::::::::::::::::::::::::::::::::::::::
#
#  PROGRAM OVERVIEW:
...
#
PROGRAM_NAME="process_level3_files_NST_v11_kml.py"
#
#xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
for x in os.listdir(inputdir):
    if 'NST' in x:
        command=pythondir+' '+datadirectry+'process_level3_NST_v11_csvo.py'+' '+inputdir+'/'+str(x)
        #
        printds()
        print(command)
        printds()

...
# NAME:
# :::::::::::::::::::::::::::::::::::::::::::::::
# process_level3_NHI_v11_csvo.py
# :::::::::::::::::::::::::::::::::::::::::::::::
"""
#  PROGRAM OVERVIEW:
#       (0) The PYTHON CODE reads WSR88D L3 NHI -Hail- information from a file.
...
# the diff is that it only plots Hail. Only makes csv./
#--------------------------------------------------------------------------------------------------
# PARAMETER TABLE:
#--------------------------------------------------------------------------------------------------
#
...
#-
#
# Programmer: Mr. Paul McCrone     04 June 2025
# Modification  :  BELOW
#========================================================================================
...
outputdir='/home/pmccrone/Pictures/tvso/NHI_test'
...
"KEWX":"Austin-San-Antonio_TX", "KEYX":"Edwards-AFB_CA", "KFCX":"Roanoke_VA", \
"KFDR":"Altus-AFB_OK", \
...
"KGRR":"Grand-Rapids_MI", "KGSP":"Greer_SC", "KGWX":"Columbus-AFB,_ MS", \
"KGYX":"Portland-Maine", \
...
"KMTX":"Salt-Lake-City_UT", "KMUX":"San-Francisco_CA", "KMVX":"Grand-Forks_ND", \
"KMXX":"Maxwell-AFB_AL", \
...
prod_sbn=["NCR","NVW","N0S","NVL","NST","APR","FTM","N1P","NTP","DPA", \
"NBU","N2U","N3U","DVL","EET", \
"DSP","NMD","NXB","NYB","NZB","N0B","N1B","NBB","N2B","N3B","NXG","NYG", \
"NZG","N0G","NAG","N1G", \
"NXX","NYX","NZK","N0X","NAX","N1X","NBX","N2X","N3X","NXC","NYC","NZC","N0C", \
"NAC","N1C","NBC", \
"N2C","N3C","NXK","NYK","NZK","N0K","NAK","N1K","NBK","N2K","N3K","NXH","NYH", \
"NZH","N0H","NAH", \
"N1H","NBH","N2H","N3H","NXM","NYM","NZM","N0M","NAM","N1M","NBM","N2M","N3M", \
"OHA","DAA","DTA", \
"DU3","DU6","HHC","DPR","TZ0","TZ1","TZ2","TV0","TV1","TV2","TZL","NXQ","NYQ","NZQ", \
"N0Q","NAQ", \
"N1Q","NBQ","N2Q","N3Q","N0R","N1R","N2R","N3R","N0Z","NCZ","N0V","N1V","N2V","N3V", \
"NXU","NYU", \
"NZU","N0U","N1U","NBU","N2U","N3U","N0S","N1S","N2S","N3S","NTV","NHI"]

dict_product_sbn={"NCR":"Short Range Composite Reflectivity 16 level/0.54 nm... 230km", \
"NCZ":"Long Range Composite Reflectivity 16 level/0.54 nm... 460km", \
"NVW":"Velocity Azimuth Display Wind Profile", \
"N0S":"Storm-Relative Mean Radial Velocity ... 0.5 degrees", \
"NVL":"Vertically Integrated Liquid", \
"NST":"Storm Cell Identification (Storm Tracking Information)", \
"APR":"Layer Composite Reflectivity APR 8 level-2.2 nm", \
"FTM":"Free Text Message", \
"N1P":"(Legacy) One-Hour Rainfall Accumulation", \
...
"EET":"High Resolution Enhanced Echo Tops", \
"DSP":"Storm Total Rainfall Accumulation","NMD":"Mesocyclone Detection Product", \
"NXB":"Base Reflectivity –248 nmi Range 256 level -0.13 nm", \
"NYB":"Base Reflectivity –248 nmi Range 256 level -0.13 nm", \
"NZB":"Base Reflectivity –248 nmi Range 256 level -0.13 nm", \
"N0B":"Base Reflectivity –248 nmi Range 256 level -0.13 nm... 0.5 degrees", \
"N1B":"Base Reflectivity –248 nmi Range 256 level -0.13 nm... 1.5 degree", \
"NBB":"Base Reflectivity –248 nmi Range 256 level -0.13 nm", \
...
PROGRAMSTARTTIME=small_print_current_time(now)
...
# Now we will get the ascii data (this is for NHI only)
printds()
print("This is for the ascii tabular data for NHI only")
...
if "NHI" in PRODUCT_ID_hdr:
    printok()
    print('This is an NHI product. This code will only decode NHI data.')
    printok()
else:
    printerr()
    print('This is NOT an NHI product. This code will only decode NHI data.')
    print('The program will end now.')
...
azran_txt='AZ/RAN'
end_txt='POSH/POH'
num_hail_line="MAX HAIL SIZE"
ptvs_txt="0/-20 C TEMP"
...
for oli in olines:
    ...
    if end_txt in oli:
        parnlist.append(iii)
    #   
    if num_hail_line in oli:
        max_hail_size.append(iii)
    #
    if ptvs_txt in oli:
        pt020list.append(iii)
    #
...
#If there are no STORM ID lines, there are no Hail, so we end the program.
#
if not start:
    printwarn()
    print("There are no NHI -Hail- storm ids in this set!")
    print("The program will end.")
    printwarn()
...
#If there are no AZ/RAN lines, there are no Hail detections, so we end the program.
#
if not azranlist:
    printwarn()
    print("There are no NHI -hail- storm ids in this set!")
...
#
printds()
print("Lines that contain "+num_hail_line)
for item in max_hail_size:
    print('Line :'+str(item)+':  '+olines[item])
printds()
...
# start , azranlist, parnlist and max_hail_size.
#
# The start contains SCIT IDs.
# The azranlist contains the az/ran pairs for each SCIT id.
# The parnlist is POSH and POH data that adds a -)- in front.
# The max_hail_size contains the MAX HAIL SIZE. 
#
...
#0002206   STORM ID            W6       A8       Q4       M9       W8       H2           
#0002330 
#0002331 V
#0002340   AZ/RAN         133/ 48  340/111  183/ 80  167/ 41  214/ 93  171/ 57           
#0002462 
#0002463 V
#0002472   POSH/POH        60/100   50/100   40/100   30/100   20/100   20/100           
#0002614 
#0002615 V
#0002624   MAX HAIL SIZE     1.00     1.00     1.00     0.75     0.50     0.50           
#0002746 
#0002747 V
#0002755 )  0/-20 C TEMP ALT 12.4/22.9 KFT(MSL) - LAST CHANGED 03:00 04/28/24 

# From ICD: 
# Notes:
# STORM ID   = Regular Storm ID from SCIT
# AZ/RAN     = Azimuth and Range (degrees and nmi)
# POSH/POH   = PROBABILITY OF SEVERE HAIL / PROBABILITY OF HAIL
# MAX HAIL SIZE.
...
#0006772   STORM ID            L3       E1       N2       K1       P0       J3           
#0007114 
#0007115 V
#0007124   AZ/RAN         319/ 33  236/108  331/ 38  239/ 14  342/ 67   11/120           
#0007246 
#0007247 V
#0007256   POSH/POH         0/ 50    0/ 50    0/ 40    0/ 40    0/ 40    0/ 30           
#0007400 
#0007401 V
#0007410   MAX HAIL SIZE    <0.50    <0.50    <0.50    <0.50    <0.50    <0.50           
#0007532 
#0007533 V
#0007541 )  0/-20 C TEMP A1869LT 14.9/24.9 KFT(MSL) - LAST CHANGED 21:00 06/03/25         
...
#0011211 P                                      HAIL                                      
#0011333 P     RADAR ID   1   DATE/TIME 04:28:24/03:00:00   NUMBER OF STORM CELLS  52     
#0011455 P                                                                                
#0011577 P      STORM       PROBABILITY OF       PROBABILITY OF       MAX EXPECTED        
#0011721 P        ID        SEVERE HAIL (%)         HAIL (%)         HAIL SIZE (IN)       
#0012043 P                                                                                
#0012165 P        W6              60                  100                 1.00            
#0012307 P        A8              50                  100                 1.00            
#0012431 P        Q4              40                  100                 1.00            
#0012553 P        M9              30                  100                 0.75            
#0012675 P        W8              20                  100                 0.50            
#0013017 P        H2              20                  100                 0.50            
#0013141 P        A0              20                  100                 0.50            
#0013263 P        U2              20                   90                 0.75            
#0013405 P        K0              10                  100                 0.50            
#0013652 
...
print("Storm ID, Current AZ-RAN, POSH, POH, MAX HAIL SIZE")
storm_index=[]
#storm_id=[]
curr_azran=[]
curr_az=[]
...
#
# We are decoding the various parts of the data- we get the storm id, the current azumith and range, and the Hail probabilites. All stored in lists. 
#
...
for newitem in start:
    ...
    for item in storm_index:
        storm_id.append(tvsonelist[item])
    ...
    printds()
    print("Here is the the azran line we are processing:")
    print(azranlist0)
    printds()
    ...
    i=2
    azposition=[]
    #item=2            # Note the first azimuth is always the third string
    #azposition.append(iteazranlist0.count("/")m)
    numberslashes=azranlist0.count("/")
    lenazranlist0=len(azranlist0)
    lenazranlist=lenazranlist0-1

    printds()
    print("The number of characters in this line is:"+str(lenazranlist0))
    print(lenazranlist)

    #>>> tvstwolist
    #['0002340', 'AZ/RAN', '133/', '48', '340/111', '183/', '80', '167/', '41', '214/', '93', '171/', '57']
    # We cannot use the normal split method, becasue '340/111' is regarded as one string, and our split method 
    # assumes they are two strings. This will not work every time.

    # Since this is not a normal way for my decode to work, I am writing up the details.
    # I will use a decoding method where I count the number of slashes and figure out where they are in the string -azranlist0-. 
    # I will ignore the first slash, as it is just "AZ/RAN".
    # I will determine the location of the slashes, record those locations, then store the azimuths and ranges
    # separately.  I will search 3 characters before the slash, then 3 characters after the slash.

    thischar=""
    slshindex=0                           # slshindex is the location in the azranlist0 where I am searching for a slash
    slshinlist=[]                         # slshinlist is a list of locations in the azranlist0 string where slashes exist.
                                          # I will ignore the first entry since it is just AZ/RAN.

    azranchar=list(range(0,lenazranlist))    

    for item in azranchar: 
        if slshindex < lenazranlist:          # I am going to search through the list of characters of azranlist0 until the last character. 
            #
            thischar=azranlist0[slshindex]    # This is the character that I am evaluating.
            print(thischar)
            #
            if thischar == "/":
                #
                print("I found a slash-")
                slshinlist.append(slshindex)  # if thischar is a slash I will add the location to my list.
                print("Found the slash at position:"+str(slshindex))
            #
    ...
    if not slshinlist:
        printwarn()
        print("There were no AZRAN slashes detected!")
        print("The program will end.")
        printwarn()
        exit() ## The program ends.

    # We need to make sure there are at least two slashes in this string! The slash in AZ/RAN does not help.

    numsllist=len(slshinlist)
    if numsllist < 2:
        printwarn()
        print("There were not enough AZRAN slashes detected! (We need two.)")
        print("The program will end.")
        printwarn()
        exit() ## The program ends.


    print("The slshinlist is:")
    print(slshinlist)

    # Logic says that there were at least two slashes in this line.
    # The first is rthe AZ/RAN. The second one should have actual data. Any other slashes that follow should also have data. 
    # I now know where the slashes are! I will begin looking at index number 1 not 0. 0 is the AZ/RAN slash, which I ignore.
    
    print("Starting the AZRAN data list part.")

    azchar=""
    rgchar=""
    posit=0      # posit is the location of the slash in the azranlist0 string.
    azlist=[]
    rglist=[]
    sllistindex=0
    for item in slshinlist:
        if sllistindex > 0:                      # This is how I ignore the first AZ/RAN. The index must be > 0
            #
            posit=int(item)
            print("The posit is:"+str(posit))
            azchar=azranlist0[posit-3:posit]     # this is the characters before the slash, the azimuth 
            rgchar=azranlist0[posit+1:posit+4]   # these are the char after the slash, the range.
            #
            try: 
                azlist.append(int(azchar))       # Append the int value of the azimuth in the list azlist 
                rglist.append(int(rgchar))       # Append the int value of the range in the list rglist.
            except:  # pylint: disable=bare-except
                azlist.append(0)
                rglist.append(0)
                printwarn()
                print("WARNING: There was a problem converting az/range to integer. Zeroes were added.")
                printwarn()
        #
    ...
    i=0
    for item in storm_index:
        curr_az.append(azlist[i])
        curr_range.append(rglist[i])
        i=i+1

    printok()
    print("Curr_az:Azimuths")
    print(curr_az)
    print()
    print("Curr_range:ranges")
    print(curr_range)
    printok()
    ...
    #
    # Now we get the ordered pair of POSH POH for each storm_id
    # This is the same method as AZ/RAN. Even ignore the / in POSH/POH.
    #
    #0007256   POSH/POH         0/ 50    0/ 50    0/ 40    0/ 40    0/ 40    0/ 30           
    ...
    printds()
    print("Here are the parts of the tvsthreelist")
    print(tvsthreelist)
    print('\n')
    ...
    numberslashes=end0.count("/")
    lenpplist0=len(end0)
    lenpplist=lenpplist0-1

    printds()
    print("The number of characters in this line is:"+str(lenpplist0))
    print(lenpplist)
    
   
    # This is the same method as the AZRAN data. I will reuse variables.
    thischar=""
    slshindex=0                           # slshindex is the location in the end0 where I am searching for a slash
    slshinlist=[]                         # slshinlist is a list of locations in the end0 string where slashes exist.
                                          # I will ignore the first entry since it is just POSH/POH.

    poshpohchar=list(range(0,lenpplist0))    

    for item in poshpohchar: 
        if slshindex < lenpplist0:          # I am going to search through the list of characters of azranlist0 until the last character. 
            #
            thischar=end0[slshindex]    # This is the character that I am evaluating.
            print(thischar)
            #
            if thischar == "/":
                #
...
#0003000   POSH/POH        60/100   40/ 90   20/ 90   20/ 90   10/100   10/ 90           

    printok()


    # Now we will decode the Max Hail Size -MEHS-
    ...
    # We can perform a split on this, but watch the < sign!

    tvsfourlist=[]
    mehs_index=max_hail_size[bigi]
    mxhailist0=olines[mehs_index]

    tvsfourlist=mxhailist0.split()

    print("Here are the values of tvsfourlist")
    print(tvsfourlist)

    i=0
    mhs_index=[]
    total_ids=i
    for item in tvsfourlist:
    ...
    print("The values of mhs_index:")
    print(mhs_index)

    printds()
    print("The total number of MEHS is:")
    print(total_ids)
    printds()

    # Do not remove this list! storm_id must be created like this here!
    for item in mhs_index:
        mxhailsz.append(tvsfourlist[item])

    printds()
    printds()

    print("Here are the MEHS items in the list mxhailsz\n")
    for item in mxhailsz:
        print(item)
    ...
    printds()
        ...
        #
        #
    print("Storm_ID,Current_AZ,Current_Range, POSH, POH, MEHS")
    ...
    for item in storm_index:
        ...
        posh_str=str(posh[i])
        poh_str=str(poh[i])
        mehs_str=str(mxhailsz[i])
        print(storm_id_str+" "+current_az_str+" "+current_rg_str+" "+posh_str+" "+poh_str+" "+mehs_str+" ")
        i=i+1
...
# Let's print everything we read in:

printok()
printok()

print("We will print all the data ewe read in.")
...
#
#
# In this section, we will plot Hail dtections various types of triangl. 
# We only plot Hail, NO Mesocyclones. TVS are not plotted .
#

if not mxhailsz:
    printerr()
    print("This error should not have happened. We cleared the first two tests. Take a good look at this file.")
    print("ERROR: There were no Hail storms to process! The program ends.")
    printerr()
    exit()
##
...
for item in storm_id:
    ...
    mxhailno=0.0    
    mxhailin=str(mxhailsz[ii])  ###
    mxhailfirst=mxhailin[0]
    ##
    if mxhailin == '<0.50' or mxhailfirst == '<':
        mxhailno=0.1    
    elif is_convertible_to_float(mxhailin): 
        mxhailno=float(mxhailin)
    else:
        mxhailno=999.9
        printwarn()
        print("There was a conversion error w- max hail size. Check data in file.")
        printwarn()
    ##
    print('mxhailno is a float and it is '+str(mxhailno))

    ax.plot(lon2,lat2,'o', label=storm_id[ii], color='blue', transform=ccrs.Geodetic())

    # Icons come from: https://kml4earth.appspot.com/icons.html

    if mxhailno == 999.9:
        print('Max Hail issue detected in '+storm_id[ii])
    else:
        if mxhailno < 1.0:
            lat_mda1.append(lat2) 
            lon_mda1.append(lon2)
            ax.plot(lon2,lat2,'^', label=storm_id[ii], color='green',markersize=8, transform=ccrs.Geodetic())
            ax.plot(lon2,lat2,'^', label=storm_id[ii], color='white',markersize=4, transform=ccrs.Geodetic())
        if mxhailno >= 1.0:
            lat_mda3.append(lat2) 
            lon_mda3.append(lon2)
            ax.plot(lon2,lat2,'^', label=storm_id[ii], color='green',markersize=8, transform=ccrs.Geodetic())
            ax.plot(lon2,lat2,'^', label=storm_id[ii], color='pink',markersize=4, transform=ccrs.Geodetic())
        if  mxhailno > 2:
            lat_mda5.append(lat2) 
            lon_mda5.append(lon2)
            ax.plot(lon2,lat2,'^', label=storm_id[ii], color='green',markersize=12, transform=ccrs.Geodetic())
            ax.plot(lon2,lat2,'^', label=storm_id[ii], color='black',markersize=2, transform=ccrs.Geodetic())
...
with open(pcsvfile, 'w', newline='') as filecsv:
    ...
    csvfield = ["Storm_Id","begining_azimuth","beginning_range","radar_lat", "radar_lon","lat","long","POSH","POH","MEHS"]
    writer.writerow(csvfield)
    ii=0
    print("i--storm_id--curr_az--curr_range--centlat--centlon--curr_lat--curr_lon--POSH--POH--MEHS")
    for item in storm_id:
        stritem=str(item)
        scaz=str(curr_az[ii])
        ...
        sposh=str(posh[ii])
        spoh=str(poh[ii])
        smehs=str(mxhailsz[ii]) 
        print(stritem+','+scaz+','+scrg+','+sctlat+','+sctlon+','+scnlat+','+scnlon+','+','+sposh+','+spoh+','+smehs)
        writer.writerow([stritem,curr_az[ii],curr_range[ii], \
            cent_lat,cent_lon,curr_lat[ii],curr_lon[ii],posh[ii],poh[ii],mxhailsz[ii] ]) 
        ii=ii+1
...
kml_filemain=thefile+".NHI_hail.kml"
...
if makekml ==1:
    ...
    for item in storm_id:
        ...
        #
        mdain='999'
        # we only plot hail, no TVS, not the MDA.
        if tvsflag == 1:
            madin='999'
        mdanbr=float( mdain )
        ...
        if mxhailno >=999.0:
            ...
            mdanbr=999.0
            #
            print('No Hail detected in '+storm_id[ii])
        else:
            if mxhailno < 1.0:
                mda1flag=1
                ff.write("    <Placemark>\n")
                ...
                ff.write("       <href>http://maps.google.com/mapfiles/kml/pal4/icon52.png</href>\n")  ## icon52 is a white triangle with red shade. Hail level 0.1 to 0.90.
                ff.write("       </Icon>\n")
                ff.write("     </IconStyle>\n")
                ff.write("     </Style>\n")
                ...
                ff.write("    </Placemark>\n")
                #
            if (mxhailno >= 1.0) and (mxhailno < 2.00):
                mda1flag=1
                ff.write("    <Placemark>\n")
                ff.write("     <Style>\n") 
                ff.write("      <IconStyle>\n")
                ff.write("      <scale>1.0</scale>\n") 
                ff.write("       <Icon>\n") 
                ff.write("       <href>https://earth.google.com/images/kml-icons/track-directional/track-0.png</href>\n")  ## track-0 is a blue up arrow. Hail level 1 to 1.9.
                ff.write("       </Icon>\n")
                ff.write("     </IconStyle>\n")
                ff.write("     </Style>\n")
                ff.write("      <name>" + str(item) + "</name>\n")
                ...
                #
                # 
            if (mxhailno >= 2.0) and (mxhailno < 3.0):
                mda3flag=1
                mda1flag=0
                ff.write("    <Placemark>\n")
                ff.write("     <Style>\n") 
                ...
                ff.write("       <href>http://maps.google.com/mapfiles/kml/shapes/open-diamond.png</href>\n")  ## open-diamond is an white diamond. Hail 2 to 2.9.                 
                ff.write("       </Icon>\n")
                ff.write("     </IconStyle>\n")
                ff.write("     </Style>\n")
                ff.write("      <name>" + str(item) + "</name>\n")
                ...
                ff.write("    </Placemark>\n")
                #
            if (mxhailno >= 3.0) and (mxhailno < 999.0):
                mda5flag=1
                mda3flag=0
                mda1flag=0
                ff.write("    <Placemark>\n")
                ...
                ff.write("       <href>http://http://maps.google.com/mapfiles/kml/shapes/triangle.png</href>\n")  ## triangle is a white triangle. Hail 3 or up.
        ...
        # This is the case where there in no hail. Simply a normal cell.
        if allinone ==0:
            ff.write("    <Placemark>\n")
            ff.write("     <Style>\n") 
            ff.write("      <IconStyle>\n")
...
if makekml ==1:
    ...
    printok()
    print("The processed kml file was NOT made. ")
    printok()
...
now=0
#Print_Current_Time(now)
PROGRAMENDTIME=small_print_current_time(now)
